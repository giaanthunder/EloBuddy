...
//                    Spells.Q.Cast(target);
					var hitchance = predi.GetHitChance(SpellSlot.Q, 1100, SkillShotType.Linear, 250, 1200, 40,Player.Instance.ServerPosition,target);
		            if (hitchance >= Config.PredQ())
		            {
		                predi.CastPredictedSpell(SpellSlot.Q, 1100, SkillShotType.Linear, 250, 1200, 40,target, true, false);
		            }
                }
            }
