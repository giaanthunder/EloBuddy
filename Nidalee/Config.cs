...
namespace Nidalee
{
    class Config
    {
        ...
        public static HitChance PredQ1()
        {
        	var mode = Config.QMenu["PredQ1"].Cast<Slider>().CurrentValue;
            switch (mode)
            {
                case 1:
        ...
        public static HitChance PredW1()
        {
        	var mode = Config.WMenu["PredW1"].Cast<Slider>().CurrentValue;
            switch (mode)
            {
                case 1:
                    return HitChance.Low;
