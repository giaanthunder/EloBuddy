...
//                        return;
//                    }
					var hc = pred.GetHitChance(SpellSlot.W, 900, SkillShotType.Circular, .650f, 0, 250,Player.Instance.Position,enemy);
		            if (hc >= HitChance.High)
		            {
		                pred.CastPredictedSpell(SpellSlot.W, 900, SkillShotType.Circular, .650f, 0, 250,enemy, false, false);
		            }
                }
...
//                        return;
//                    }
					var hc = pred.GetHitChance(SpellSlot.Q, 1050, SkillShotType.Linear, .25f, 1600, 70,Player.Instance.Position,enemy);
		            if (hc >= HitChance.High)
		            {
		                pred.CastPredictedSpell(SpellSlot.Q, 1050, SkillShotType.Linear, .25f, 1600, 70,enemy, true, false);
		            }
                }
...
//                        return;
//                    }
					var hc = pred.GetHitChance(SpellSlot.W, 900, SkillShotType.Circular, .650f, 0, 250,Player.Instance.Position,target);
		            if (hc >= HitChance.High)
		            {
		                pred.CastPredictedSpell(SpellSlot.W, 900, SkillShotType.Circular, .650f, 0, 250,target, false, false);
		            }
                }
            }
...
//                        return;
//                    }
					var hc = pred.GetHitChance(SpellSlot.Q, 1050, SkillShotType.Linear, .25f, 1600, 70,Player.Instance.Position,target);
		            if (hc >= HitChance.High)
		            {
		                pred.CastPredictedSpell(SpellSlot.Q, 1050, SkillShotType.Linear, .25f, 1600, 70,target, true, false);
		            }
                }
            }
